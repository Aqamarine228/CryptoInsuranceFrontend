          ...
          <b-col v-for="option in 20" :key="option" lg="6" class="mb-1">
            <li>
              <div class="d-flex align-items-center placeholder-glow">
                <div class="flex-grow-1" style="font-size: 1rem"><span class="placeholder w-75 placeholder-sm"></span></div>
              </div>
            </li>
          </b-col>
        </b-row>
          ...
          <b-col v-for="option in insurance.options" :key="option.id" lg="6" class="mb-1">
            <li>
              <div class="d-flex align-items-center">
                ...
                <div class="flex-grow-1" style="font-size: 1rem">{{option.name}}</div>
              </div>
            </li>
          </b-col>
        </b-row>
