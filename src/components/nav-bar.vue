        ...
        <div class="d-flex align-items-center">
            ...
            <div class="dropdown-menu dropdown-menu-xl dropdown-menu-end p-0 dropdown-menu-cart"
              ...
              <div class="p-3 border-top-0 border-start-0 border-end-0 border-dashed border">
                <b-row class="align-items-center">
                  ...
                  <b-col cols="auto">
                    <b-badge variant="warning-subtle" class="bg-warning-subtle text-warning fs-13"><span class="cartitem-badge">7</span>
                      items</b-badge>
                  </b-col>
                </b-row>
              </div>
                ...
                <div class="p-2">
                    ...
                    <div class="d-flex align-items-center">
                      ...
                      <div class="flex-grow-1">
                        <h6 class="mt-0 mb-1 fs-14">
                          <b-link href="#" class="text-reset">Branded
                            T-Shirts</b-link>
                        </h6>
                  ...
                  <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                    <div class="d-flex align-items-center">
                      ...
                      <div class="flex-grow-1">
                        <h6 class="mt-0 mb-1 fs-14">
                          <b-link href="#" class="text-reset">Bentwood Chair</b-link>
                        </h6>
                        <p class="mb-0 fs-12 text-muted">
                  ...
                  <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                    <div class="d-flex align-items-center">
                      ...
                      <div class="flex-grow-1">
                        <h6 class="mt-0 mb-1 fs-14">
                          <b-link href="#" class="text-reset">Gray
                  ...
                  <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                    <div class="d-flex align-items-center">
                      ...
                      <div class="flex-grow-1">
                        <h6 class="mt-0 mb-1 fs-14">
                          <b-link href="#" class="text-reset">Stillbird Helmet
                          </b-link>
                        </h6>
                        <p class="mb-0 fs-12 text-muted">
              ...
              <div class="p-3 border-bottom-0 border-start-0 border-end-0 border-dashed border" id="checkout-elem">
                ...
                <b-link href="#" class="btn btn-success text-center w-100">
                  Checkout
                </b-link>
              </div>
            </div>
          ...
          <div class="dropdown ms-sm-3 header-item topbar-user">
            ...
            <div class="dropdown-menu dropdown-menu-end">
              ...
              <router-link class="dropdown-item" to="#"><b-badge variant="success-subtle"
