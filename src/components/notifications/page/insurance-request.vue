...
<b-card>
  <b-card-body>
    ...
    <div class="mt-4 pt-2 d-flex align-items-center justify-content-center flex-column">
      <h4>{{ $t(approved ? 'notifications.insuranceRequestApproved' : 'notifications.insuranceRequestRejected')}}</h4>
      <p class="text-muted mx-4" v-if="approved">{{$t('notifications.insuranceRequestApprovedText')}}</p>
