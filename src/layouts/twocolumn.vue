              ...
              <SimpleBar class="navbar-nav" id="navbar-nav">
                    ...
                    <ul class="nav nav-sm flex-column">
                      ...
                      <li class="nav-item">
                        ...
                        <div class="collapse menu-dropdown" id="jobs">
                          <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                              <router-link to="#" class="nav-link" data-key="t-job-statistics">
                                {{ $t("t-statistics") }}
                              </router-link>
                            </li>
                            ...
                            <li class="nav-item">
                              ...
                              <div class="collapse menu-dropdown" id="sidebarjoblist">
                                <ul class="nav nav-sm flex-column">
                                  <li class="nav-item">
                                    <router-link to="#" class="nav-link" data-key="t-lists">
                                      {{ $t("t-list") }}
                                    </router-link>
                                  </li>
                                  <li class="nav-item">
                                    <router-link to="#" class="nav-link" data-key="t-grid">
                                      {{ $t("t-grid") }}
                                    </router-link>
                                  </li>
                                  <li class="nav-item">
                            ...
                            <li class="nav-item">
                              <router-link to="#" class="nav-link" data-key="t-application">
                                {{ $t("t-application") }}
                              </router-link>
                            </li>
                            <li class="nav-item">
                              <router-link to="#" class="nav-link" data-key="t-new">
                                {{ $t("t-new-job") }}
                              </router-link>
                            </li>
                            <li class="nav-item">
                              <router-link to="#" class="nav-link" data-key="t-companies-list">
                                {{ $t("t-companies-list") }}
                              </router-link>
                            </li>
                            <li class="nav-item">
                              <router-link to="#" class="nav-link" data-key="t-job-categories">
                                {{ $t("t-job-categories") }}
                              </router-link>
                            </li>
                          </ul>
                      ...
                      <li class="nav-item">
                        <router-link to="#" class="nav-link" data-key="t-api-key">
                          {{ $t("t-api-key") }}
                        </router-link>
                      </li>
                    </ul>
                ...
                <li class="nav-item">
                  <div class="collapse menu-dropdown" id="sidebarlanding">
                    <ul class="nav nav-sm flex-column">
                      <li class="nav-item">
                        <router-link to="#" target="_blank" class="nav-link" data-key="t-one-page">{{
                            $t("t-one-page")
                          }}
                        </router-link>
                      </li>
                      ...
                      <li class="nav-item">
                        <router-link to="#" target="_blank" class="nav-link" data-key="t-nft-landing">{{
                            $t("t-nft-landing")
                          }}
                        </router-link>
                      </li>
                      ...
                      <li class="nav-item">
                        <router-link to="#" target="_blank" class="nav-link" data-key="t-nft-landing">{{ $t("t-job") }}
                        </router-link>
                      </li>
                    ...
                    <b-row>
                      ...
                      <b-col lg="4">
                        <ul class="nav nav-sm flex-column">
                          ...
                          <li class="nav-item">
                            <router-link to="#" class="nav-link" data-key="t-links">{{ $t("t-links") }}
                      ...
                      <li class="nav-item">
                        ...
                        <div class="collapse menu-dropdown" id="sidebarApexcharts">
                          <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                              <router-link to="#" class="nav-link" data-key="t-range-area">{{ $t("t-range-area") }}
                                <b-badge variant="success" class="badge-pill" data-key="t-new">{{ $t("t-new") }}
                                </b-badge>
                              </router-link>
                            </li>
                            <li class="nav-item">
                              <router-link to="#" class="nav-link" data-key="t-funnel">{{ $t("t-funnel") }}
                                <b-badge variant="success" class="badge-pill" data-key="t-new">{{ $t("t-new") }}
                                </b-badge>
                              </router-link>
                            </li>
